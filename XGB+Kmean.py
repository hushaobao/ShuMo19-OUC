...
def process_for_kmeans(df):
    ...
    cate_cols = ['PROVINCE', 'SEX', 'AGE','occupation', 'mobile_fixed_days', 'adr_stability_days', 'consume_steady_byxs_1y',
                 ...
                 'ebill_pay_amt_3m', 'ebill_pay_amt_1m', 'avg_puc_sdm_last_1y', 'xfdc_index', 'pre_1y_pay_cnt',
                 'pre_1y_pay_amount', 'auth_fin_last_1m_cnt', 'auth_fin_last_3m_cnt', 'auth_fin_last_6m_cnt',
                 'credit_pay_amt_1m', 'credit_pay_amt_3m', 'credit_pay_amt_6m', 'credit_pay_amt_1y',
                 'credit_pay_months_1y', 'credit_total_pay_months', 'credit_duration', 'positive_biz_cnt_1y',
                 'ovd_order_cnt_1m', 'ovd_order_amt_1m', 'ovd_order_cnt_3m', 'ovd_order_amt_3m', 'ovd_order_cnt_6m',
                 'ovd_order_amt_6m', 'ovd_order_cnt_12m', 'ovd_order_amt_12m', 'ovd_order_c0t_3m_m1_status',
                 'ovd_order_c0t_6m_m1_status', 'ovd_order_c0t_12m_m1_status', 'ovd_order_c0t_12m_m3_status',
                 'ovd_order_c0t_12m_m6_status', 'ovd_order_c0t_21_m3_status', 'ovd_order_c0t_21_m6_status',
                 'ovd_order_c0t_51_m3_status', 'ovd_order_c0t_51_m6_status', 'relevant_stability', 'sns_pii']
...
def train_by_kmeans():
    ...
    clf = KMeans(algorithm='auto', copy_x=True, init='k-means++', max_iter=400,
...
def main():
    ...
    result['label'] = 100 - (result['label_x'] * 0.5 + result['label_y'] * 0.5)
